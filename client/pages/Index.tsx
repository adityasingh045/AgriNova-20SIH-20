    ...
    <div className="relative">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            ...
            <p className="text-lg text-muted-foreground max-w-xl">
              Fuse satellite, drone and in-field sensor data to detect stress early, optimize irrigation and nutrition, and forecast pest risks with explainable AI.
            </p>
          ...
          <div className="grid gap-6">
            <div className="rounded-2xl border bg-card p-4 shadow-sm">
              <div className="flex items-center justify-between pb-2">
                ...
                <div className="rounded-md bg-emerald-600/10 text-emerald-700 dark:text-emerald-300 px-2 py-1 text-xs font-semibold">Healthy</div>
              </div>
              <div className="h-48">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="rounded-2xl border bg-card p-4 shadow-sm">
                <div className="flex items-center justify-between pb-2">
                  ...
                  <span className="rounded-md bg-cyan-600/10 text-cyan-700 dark:text-cyan-300 px-2 py-1 text-xs font-semibold">kPa</span>
                </div>
                <div className="h-32">
                  <ResponsiveContainer width="100%" height="100%">
              ...
              <div className="rounded-2xl border bg-card p-4 shadow-sm">
                <div className="flex items-center justify-between pb-2">
                  <p className="text-sm text-muted-foreground">Pest Risk • 7d</p>
                  <span className="rounded-md bg-amber-500/10 text-amber-700 dark:text-amber-300 px-2 py-1 text-xs font-semibold">Low</span>
                </div>
                <div className="grid grid-cols-5 gap-1">
                  {Array.from({ length: 25 }).map((_, i) => (
                    <div key={i} className="aspect-square rounded-sm" style={{ background: `hsl(var(--primary)/${0.1 + ((i % 5) / 10)})` }} />
                  ))}
                </div>
              </div>
            </div>
      ...
      <section className="container mx-auto px-4 pb-20">
        <div className="grid md:grid-cols-4 gap-6">
          <Feature icon={<Radar className="size-5" />} title="Crop Health Index" desc="NDVI, NDRE and custom spectral indices detect stress before it’s visible." />
          <Feature icon={<Droplets className="size-5" />} title="Soil & Irrigation" desc="Moisture and salinity from probes and weather for precision irrigation." />
          <Feature icon={<Bug className="size-5" />} title="Pest Forecasts" desc="Risk models fuse climate and imagery to predict outbreaks up to 14 days." />
          <Feature icon={<Satellite className="size-5" />} title="Any Data Source" desc="Satellites, drones, tractors and IoT sensors unify into one platform." />
        </div>
      </section>
        ...
        <div className="grid lg:grid-cols-2 gap-10 items-center rounded-2xl border p-6 md:p-10 bg-card">
          <div className="space-y-4">
            ...
            <div className="flex gap-3">
              <a href="#contact"><Button>Talk to sales</Button></a>
  ...
  return (
    <div className="rounded-xl border bg-card p-5 shadow-sm">
      <div className="flex items-center gap-3 text-primary">
        <div className="grid size-9 place-items-center rounded-md bg-primary/10">{icon}</div>
